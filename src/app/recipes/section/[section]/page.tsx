...
const allSectionData: Record<string, {title: string;subtitle: string;label?: string;recipes: Recipe[];}> = {
  trending: {
    ...
    { title: 'Mango Coconut Chia Pudding', creator: 'Priya Nair', time: '10 min', difficulty: 'Easy', image: "https://images.unsplash.com/photo-1671527281209-7b3a8dff51ce", alt: 'Layered mango coconut chia pudding in a glass jar topped with fresh mango slices', slug: 'mango-coconut-chia-pudding' },
    { title: 'Birria Tacos', creator: 'Rosa Gutierrez', time: '3 hrs', difficulty: 'Medium', image: "https://images.unsplash.com/photo-1674277196243-ff6fc26e837c", alt: 'Crispy birria tacos dipped in rich consommé with melted cheese and cilantro', slug: 'birria-tacos' },
    ...
    { title: 'Shrimp Tacos', creator: 'Rosa Gutierrez', time: '20 min', difficulty: 'Easy', image: "https://img.rocket.new/generatedImages/rocket_gen_img_10219b7a4-1772055932983.png", alt: 'Crispy shrimp tacos with cabbage slaw, avocado, and chipotle crema', slug: 'shrimp-tacos' },
    ...
    { title: 'Banana Nice Cream', creator: 'Priya Nair', time: '5 min', difficulty: 'Easy', image: "https://images.unsplash.com/photo-1455099797519-a70bccc199c1", alt: 'Creamy one-ingredient banana nice cream in a bowl with toppings', slug: 'banana-nice-cream' },
    ...
    { title: 'Watermelon Feta Salad', creator: 'Leila Hassan', time: '10 min', difficulty: 'Easy', image: "https://images.unsplash.com/photo-1597653291869-90564e44078f", alt: 'Refreshing watermelon and feta salad with mint and balsamic glaze', slug: 'watermelon-feta-salad' },
  ...
  breakfast: {
    ...
    { title: 'French Toast', creator: 'Sofia Patel', time: '15 min', difficulty: 'Easy', image: "https://img.rocket.new/generatedImages/rocket_gen_img_199e41197-1782117159194.png", alt: 'Golden thick-cut French toast dusted with powdered sugar and fresh strawberries', slug: 'french-toast' },
    ...
    { title: 'Breakfast Hash', creator: 'Jake Torres', time: '25 min', difficulty: 'Easy', image: "https://images.unsplash.com/photo-1729450411363-ba702747e240", alt: 'Crispy potato breakfast hash with peppers, onions, and fried eggs on top', slug: 'breakfast-hash' },
    ...
    { title: 'Dutch Baby Pancake', creator: 'Sofia Romano', time: '25 min', difficulty: 'Easy', image: "https://images.unsplash.com/photo-1586195833982-47e978de8f40", alt: 'Puffed Dutch baby pancake with lemon juice, powdered sugar, and berries', slug: 'dutch-baby-pancake' },
    ...
    { title: 'Cinnamon French Toast Sticks', creator: 'Emma Walsh', time: '15 min', difficulty: 'Easy', image: "https://img.rocket.new/generatedImages/rocket_gen_img_17f60aed6-1785351748859.png", alt: 'Cinnamon sugar French toast sticks with maple syrup for dipping', slug: 'cinnamon-french-toast-sticks' },
    ...
    { title: 'Açaí Smoothie', creator: 'Aisha Sharma', time: '5 min', difficulty: 'Easy', image: "https://images.unsplash.com/photo-1561997315-6d0610a96b9c", alt: 'Thick açaí smoothie with banana, almond milk, and honey', slug: 'acai-smoothie' },
    ...
    { title: 'Breakfast Bowl', creator: 'Priya Nair', time: '20 min', difficulty: 'Easy', image: "https://images.unsplash.com/photo-1575732957508-da0f9f379b5e", alt: 'Nourishing breakfast bowl with quinoa, roasted vegetables, and a poached egg', slug: 'breakfast-bowl' },
  ...
  quick: {
    ...
    { title: 'Greek Salad', creator: 'Sofia Patel', time: '10 min', difficulty: 'Easy', image: "https://images.unsplash.com/photo-1727618534372-ddc94e872d04", alt: 'Fresh Greek salad with cucumber, tomatoes, olives, feta, and oregano', slug: 'greek-salad' },
    ...
    { title: 'Scrambled Eggs', creator: 'Marco Rossi', time: '10 min', difficulty: 'Easy', image: "https://img.rocket.new/generatedImages/rocket_gen_img_1c29c00e3-1765572953934.png", alt: 'Perfectly soft scrambled eggs with chives and butter on toast', slug: 'scrambled-eggs' },
    ...
    { title: 'Salmon Rice Bowl', creator: 'Yuna Kim', time: '15 min', difficulty: 'Easy', image: "https://img.rocket.new/generatedImages/rocket_gen_img_1900c313c-1772799440716.png", alt: 'Spicy salmon rice bowl with cucumber, avocado, and sriracha mayo', slug: 'salmon-rice-bowl' },
    { title: 'Omelette', creator: 'Marco Rossi', time: '10 min', difficulty: 'Easy', image: "https://img.rocket.new/generatedImages/rocket_gen_img_109193e74-1772618738820.png", alt: 'Fluffy French omelette with herbs, cheese, and mushrooms', slug: 'omelette' },
    ...
    { title: 'Steak Salad', creator: 'Jake Torres', time: '20 min', difficulty: 'Easy', image: "https://images.unsplash.com/photo-1614187860064-8c0442c793c5", alt: 'Sliced steak salad with arugula, cherry tomatoes, and balsamic dressing', slug: 'steak-salad' },
    ...
    { title: 'Egg Drop Soup', creator: 'Lin Wei', time: '15 min', difficulty: 'Easy', image: "https://img.rocket.new/generatedImages/rocket_gen_img_1258cc50e-1772472349165.png", alt: 'Silky egg drop soup with green onions and sesame oil', slug: 'egg-drop-soup' },
    ...
    { title: 'Loaded Baked Potato', creator: 'Jake Torres', time: '15 min', difficulty: 'Easy', image: "https://images.unsplash.com/photo-1729450411363-ba702747e240", alt: 'Loaded baked potato with sour cream, cheese, bacon, and chives', slug: 'loaded-baked-potato' },
  ...
  global: {
    ...
    { title: 'Chicken Shawarma', creator: 'Leila Hassan', cuisine: 'Middle Eastern', time: '30 min', difficulty: 'Medium', image: "https://img.rocket.new/generatedImages/rocket_gen_img_1444be92e-1767548001932.png", alt: 'Spiced chicken shawarma wrap with garlic sauce and pickled vegetables', slug: 'chicken-shawarma' },
    ...
    { title: 'Margherita Pizza', creator: 'Marco Rossi', cuisine: 'Italian', time: '30 min', difficulty: 'Medium', image: "https://images.unsplash.com/photo-1703784022146-b72677752ce5", alt: 'Classic margherita pizza with fresh mozzarella, tomato sauce, and basil leaves', slug: 'margherita-pizza' },
    { title: 'Cacio e Pepe', creator: 'Sofia Romano', cuisine: 'Italian', time: '20 min', difficulty: 'Medium', image: 'https://img.rocket.new/generatedImages/rocket_gen_img_1e568055d-1772085885754.png', alt: 'Creamy cacio e pepe pasta with black pepper and pecorino romano cheese', slug: 'cacio-e-pepe' },
    { title: 'Birria Tacos', creator: 'Rosa Gutierrez', cuisine: 'Mexican', time: '3 hrs', difficulty: 'Medium', image: "https://images.unsplash.com/photo-1611250188496-e966043a0629", alt: 'Crispy birria tacos dipped in rich consommé with melted cheese and cilantro', slug: 'birria-tacos' },
    { title: 'Miso Glazed Eggplant', creator: 'Yuki Tanaka', cuisine: 'Japanese', time: '25 min', difficulty: 'Easy', image: "https://img.rocket.new/generatedImages/rocket_gen_img_1635683f8-1772057315477.png", alt: 'Roasted eggplant with sweet miso glaze and sesame seeds', slug: 'miso-glazed-eggplant' },
    { title: 'Falafel Wrap', creator: 'Leila Hassan', cuisine: 'Middle Eastern', time: '30 min', difficulty: 'Medium', image: "https://images.unsplash.com/photo-1636168655089-5e625a233354", alt: 'Crispy falafel wrap with hummus, vegetables, and tahini sauce', slug: 'falafel-wrap' },
    { title: 'Spicy Ramen', creator: 'Yuna Kim', cuisine: 'Japanese', time: '20 min', difficulty: 'Easy', image: "https://images.unsplash.com/photo-1710573558322-a8d98ecd5053", alt: 'Spicy instant ramen upgraded with soft-boiled egg, nori, and chili oil', slug: 'spicy-ramen' },
    { title: 'Teriyaki Chicken Bowl', creator: 'Yuki Tanaka', cuisine: 'Japanese', time: '25 min', difficulty: 'Easy', image: "https://images.unsplash.com/photo-1634640848446-6d4d670b5142", alt: 'Teriyaki glazed chicken over steamed rice with broccoli and sesame seeds', slug: 'teriyaki-chicken-bowl' }]
  },
  pasta: {
    title: 'Pasta & Noodles',
    label: 'Comfort food',
  ...
  healthy: {
    ...
    { title: 'Berry Smoothie Bowl', creator: 'Aisha Sharma', time: '10 min', difficulty: 'Easy', image: "https://images.unsplash.com/photo-1623783398179-078261d586d3", alt: 'Thick acai smoothie bowl topped with fresh berries, granola, and coconut flakes', slug: 'berry-smoothie-bowl' },
    ...
    { title: 'Banana Nice Cream', creator: 'Priya Nair', time: '5 min', difficulty: 'Easy', image: "https://images.unsplash.com/photo-1561997315-6d0610a96b9c", alt: 'Creamy one-ingredient banana nice cream in a bowl with toppings', slug: 'banana-nice-cream' }]
  },
  vegetarian: {
  ...
  bbq: {
    ...
    { title: 'Smash Burger', creator: 'Jake Torres', time: '15 min', difficulty: 'Easy', image: 'https://img.rocket.new/generatedImages/rocket_gen_img_115ac9fe5-1772550917596.png', alt: 'Crispy smash burger with caramelized onions and special sauce on a bun', slug: 'smash-burger' },
    { title: 'Garlic Butter Steak Bites', creator: 'Jake Torres', time: '15 min', difficulty: 'Easy', image: "https://img.rocket.new/generatedImages/rocket_gen_img_1db10218f-1772446279214.png", alt: 'Sizzling garlic butter steak bites with herbs in a cast iron pan', slug: 'garlic-butter-steak-bites' },
    { title: 'Honey Garlic Salmon', creator: 'Maria Chen', time: '20 min', difficulty: 'Easy', image: "https://img.rocket.new/generatedImages/rocket_gen_img_13581a46c-1772646980537.png", alt: 'Glazed honey garlic salmon fillets with sesame seeds and green onions', slug: 'honey-garlic-salmon' },
    { title: 'Sheet Pan Fajitas', creator: 'Carlos Mendez', time: '30 min', difficulty: 'Easy', image: 'https://images.unsplash.com/photo-1679060301613-2ff2050db858', alt: 'Colorful bell peppers and chicken strips roasted on a sheet pan for fajitas', slug: 'sheet-pan-fajitas' },
    { title: 'Beef Bulgogi', creator: 'Min-Jun Oh', time: '30 min', difficulty: 'Easy', image: 'https://img.rocket.new/generatedImages/rocket_gen_img_1f028ab6b-1779993139967.png', alt: 'Marinated Korean beef bulgogi with sesame seeds and green onions over rice', slug: 'beef-bulgogi' },
    { title: 'Chicken Shawarma', creator: 'Leila Hassan', time: '30 min', difficulty: 'Medium', image: "https://img.rocket.new/generatedImages/rocket_gen_img_1444be92e-1767548001932.png", alt: 'Spiced chicken shawarma wrap with garlic sauce and pickled vegetables', slug: 'chicken-shawarma' },
  ...
  soups: {
    ...
    { title: 'Spicy Ramen', creator: 'Yuna Kim', time: '20 min', difficulty: 'Easy', image: "https://images.unsplash.com/photo-1710573558322-a8d98ecd5053", alt: 'Spicy instant ramen upgraded with soft-boiled egg, nori, and chili oil', slug: 'spicy-ramen' },
    { title: 'Beef Pho', creator: 'Nguyen Lan', time: '3 hrs', difficulty: 'Hard', image: "https://images.unsplash.com/photo-1707153438523-3d32f2bed0f3", alt: 'Steaming bowl of Vietnamese beef pho with rice noodles, herbs, and bean sprouts', slug: 'beef-pho' },
  ...
  family: {
    ...
    { title: 'BBQ Baby Back Ribs', creator: 'Jake Torres', time: '3 hrs', difficulty: 'Medium', image: "https://img.rocket.new/generatedImages/rocket_gen_img_1c57cdb81-1770832572556.png", alt: 'Smoky BBQ baby back ribs with caramelized sauce on a wooden board', slug: 'bbq-baby-back-ribs' },
    { title: 'Mushroom Risotto', creator: 'Maria Chen', time: '40 min', difficulty: 'Medium', image: "https://images.unsplash.com/photo-1680420574628-225def8eea0a", alt: 'Creamy mushroom risotto with parmesan cheese and fresh thyme garnish', slug: 'mushroom-risotto' },
    { title: 'Chicken Tikka Masala', creator: 'Aisha Sharma', time: '50 min', difficulty: 'Medium', image: "https://images.unsplash.com/photo-1657205937641-01d8c906274f", alt: 'Rich and creamy chicken tikka masala in a bowl with naan bread on the side', slug: 'chicken-tikka-masala' },
    { title: 'Cheesecake', creator: 'Sofia Patel', time: '4 hrs', difficulty: 'Medium', image: "https://img.rocket.new/generatedImages/rocket_gen_img_1e366641f-1772871592638.png", alt: 'Creamy New York style cheesecake with graham cracker crust and berry topping', slug: 'cheesecake' }]
  }
};
